require 'page-object'
#test 5 variables
$optionsMenu = '/html/body/div[3]/div[1]/div/div/a[2]'
$musicVideoOption = '/html/body/div[3]/div[1]/div/div/div[2]/ul/li[1]/a'
...
class SearchSections 
    ...
    wait.until { driver.find_element(xpath: $musicVideoOption).displayed?}
